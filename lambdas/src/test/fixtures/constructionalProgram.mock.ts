...
export const constructionalProgramMock: ConstructionalProgram = {
  constructionalAssets: {
    conditionsWhereTargetPatternOccurs: [
      {
        ...
        notes:
          "Occurs without the need for food, indicating some existing control.",
      },
    ],
    notes:
    ...
    relevantSkills: [
      {
        context:
          "When food is present or when the person stands upright with hands clasped",
  ...
  controlAnalysis: {
    ...
    initialConditions: {
      behaviorObserved:
        "Dog sits calmly near person, not jumping or initiating unwanted behavior.",
      ...
      description:
        "Person standing upright near couch, facing couch, with hands clasped.",
      evidence: [
  ...
  initialization: {
    ...
    startingInteraction: {
      ...
      reinforcer:
        "Petting and verbal praise while dog has all four feet on the ground",
      targetPattern:
        "Dog remains sitting calmly near person without jumping or unwanted behavior",
    },
  },
  schemaVersion: "1.0",
  targetOutcome: {
    ...
    phases: [
      {
        approximations: [
          {
            changeFromPrevious: {
              adjustment:
                "Shift weight forward slightly from fully upright stance",
              dimension: "posture",
            },
            conditions: [
            ...
            controlCriterion: {
              ...
              sufficientToAdvance:
                "Dog reliably maintains calm sitting for three repetitions",
            },
            id: "phase1_approx1",
            order: 0,
            recovery: {
            ...
            reinforcer:
              "Petting with one hand and verbal praise when dog remains sitting calmly",
            targetPattern:
              "Dog continues calm sitting with no jumping or excitement",
          },
          {
            changeFromPrevious: {
            ...
            controlCriterion: {
              ...
              sufficientToAdvance:
                "Dog demonstrates stable calm pattern over three sessions",
            },
            id: "phase1_approx2",
            order: 1,
            recovery: {
            ...
            targetPattern:
              "Dog remains sitting calmly without moving toward couch or jumping",
          },
          {
            changeFromPrevious: {
            ...
            controlCriterion: {
              evidenceOfControl:
                "Dog remains calm for 10+ seconds during moderate knee bend",
              sufficientToAdvance:
                "Consistent calm on three separate occasions",
            },
            id: "phase1_approx3",
            order: 2,
            recovery: {
            ...
            reinforcer:
              "Two-handed petting and verbal praise while dog sits or lies down",
            targetPattern:
              "Dog stays calm and seated without jumping or play biting",
          },
        ],
        entryCondition:
        ...
        id: "phase1",
        notes:
          "Gradually introduce lowering posture while maintaining calm dog behavior.",
        order: 0,
        ...
        approximations: [
          {
            ...
            controlCriterion: {
              evidenceOfControl:
                "Dog remains calm for the duration of person sitting briefly",
            ...
            targetPattern:
              "Dog remains calm and seated or lying down throughout",
          },
          {
            changeFromPrevious: {
            ...
            controlCriterion: {
              evidenceOfControl:
                "Dog remains calm for entire 5-second duration",
          ...
          },
          {
            ...
            controlCriterion: {
              evidenceOfControl:
                "Dog remains calmly seated or lying during person sitting",
            ...
            targetPattern:
              "Dog remains settled with position shifts allowed but no jumping",
          },
        ],
        entryCondition:
          "Person bends knees moderately near couch; dog sits calmly.",
        id: "phase2",
      ...
      },
      {
        approximations: [
          {
            ...
            controlCriterion: {
              evidenceOfControl:
                "Dog remains settled despite human posture shifts",
          ...
          },
          {
            ...
            controlCriterion: {
              evidenceOfControl:
                "Dog stays calm and does not jump or initiate play",
          ...
          },
          {
            ...
            controlCriterion: {
              evidenceOfControl:
                "Dog maintains calm pattern throughout session",
            ...
            targetPattern:
              "Dog remains calm, occasionally shifting but not jumping",
          },
        ],
        entryCondition: "Person seated fully on couch; dog calm and settled.",
        id: "phase3",
        notes:
          "Introduce natural variations in human behavior for durable control.",
        order: 2,
        reinforcers: ["Petting", "Verbal praise"],
        targetPattern:
        ...
        title:
          "Generalize calm sitting pattern during natural sitting behavior",
      },
    ],
    terminalCriterion:
