...
exports.constructionalProgramMock = void 0;
exports.constructionalProgramMock = {
    constructionalAssets: {
        ...
        notes: "The dog clearly enjoys petting, scratches, belly rubs, and praise, which can support the desired interaction.",
        relevantSkills: [
            {
    ...
    controlAnalysis: {
        disturbingPattern: "Dog begins moving toward couch, jumping, or initiating play biting as person bends knees.",
        initialConditions: {
        ...
        targetPattern: "Dog sits or lies down calmly next to or on the couch while the person sits watching TV, occasionally shifting position but remaining settled.",
        terminalConditions: {
            description: "Person seated on couch watching TV, allowing dog to sit or lie down next to or on couch with controlled shifting.",
            targetPattern: "Dog remains sitting or lying down calmly, shifting positions without jumping or unwanted behavior throughout entire sitting period.",
        },
        transitionPoint: {
    ...
    initialization: {
        readinessCriterion: "Dog maintains calm sitting pattern reliably while person stands facing couch with hands clasped, at least 90% of the time over three consecutive sessions",
        startingInteraction: {
            conditions: [
                "Person stands upright near the couch facing the couch with hands clasped",
                "Dog sits calmly near the person",
            ],
            controlCriterion: "Dog sits calmly for at least 30 seconds across multiple repetitions without losing calmness",
    ...
    schemaVersion: "1.0",
    targetOutcome: {
        clarifiedOutcome: "When you sit on the couch watching TV, your dog is either sitting or lying down beside you on the floor or on the couch, shifting position occasionally while remaining settled.",
        desiredInteractionPattern: "Dog sits or lies down next to or on the couch with the person as they watch TV, with occasional shifting while remaining seated or lying down.",
        isObservable: true,
        isPositive: true,
        notes: "The pattern includes allowed movement such as shifting position while preserving sitting or lying down near the person.",
        primaryContext: "Sitting on the couch watching TV at home",
        rawAnswer: "When I sit on the couch to watch TV, my dog would be sitting or lying down on the floor next to the couch or on the couch with me, allowed to shift positions but not jump on me.",
        ...
        phases: [
            {
                approximations: [
                    {
                        ...
                        controlCriterion: {
                            evidenceOfControl: "Dog remains sitting calmly for 15 seconds while person shifts weight",
                    ...
                    },
                    {
                        ...
                        controlCriterion: {
                            evidenceOfControl: "Dog maintains sitting for 10 seconds while person bends knees slightly",
                ...
                entryCondition: "Person stands upright near couch facing couch with hands clasped; dog sits calmly.",
                id: "phase1",
                notes: "Gradually introduce lowering posture while maintaining calm dog behavior.",
                order: 0,
                reinforcers: ["Petting", "Verbal praise"],
                targetPattern: "Dog continues sitting calmly near person despite beginning changes in person's posture.",
                terminalCriterion: "Dog sits calmly for at least 10 seconds after person begins bending knees slightly.",
            ...
            },
            {
                ...
                targetPattern: "Dog remains sitting or lying calmly next to or on couch as person lowers onto couch seat.",
                terminalCriterion: "Dog sits or lies calmly for 10 seconds as person briefly sits on edge of couch.",
            ...
            },
            {
                ...
                order: 2,
                reinforcers: ["Petting", "Verbal praise"],
                targetPattern: "Dog maintains calm sitting or lying down with occasional shifting as person interacts naturally in sitting context.",
                terminalCriterion: "Dog remains calm during at least 10 minutes of natural sitting behavior including posture shifts, use of remote, and watching TV.",
                title: "Generalize calm sitting pattern during natural sitting behavior",
            },
        ],
        terminalCriterion: "Dog remains consistently calm, sitting or lying down with allowed shifting, throughout the entire typical duration of sitting on couch watching TV.",
    },
};
